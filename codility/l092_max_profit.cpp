...
//
// An array A consisting of N integers is given. It contains daily prices of
// a stock share for a period of N consecutive days. If a single share was
// bought on day P and sold on day Q, where 0 ≤ P ≤ Q < N, then the profit of
...
int max_profit_sum(const vector<int> &A)
{
...
////////////////////////////////////////////////////////////////////////////////
TEST_CASE("Max Profit", "[codility]")
{
    REQUIRE(max_profit_sum({23171, 21011, 21123, 21366, 21013, 21367}) == 356);
}