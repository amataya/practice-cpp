...
// another element that has the same value, except for one element
...
using namespace std;
////////////////////////////////////////////////////////////////////////////////
int odd_occurrence(vector<int> A)
{
    int odd = 0;
    for (const auto &n : A)
        odd ^= n;
...
////////////////////////////////////////////////////////////////////////////////
TEST_CASE("Odd Occurrence", "[codility]")
{
    REQUIRE(odd_occurrence({9, 3, 9, 3, 9, 7, 9}) == 7);
}