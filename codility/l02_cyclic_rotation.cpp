...
using namespace std;
////////////////////////////////////////////////////////////////////////////////
vector<int> cyclic_rotation(vector<int> A, int K)
{
    if (A.size() == 0 || K == 0 || A.size() == K)
        return A;
...
////////////////////////////////////////////////////////////////////////////////
TEST_CASE("Cyclic Rotation", "[codility]")
{
    REQUIRE(cyclic_rotation({3, 8, 9, 7, 6}, 3) == vector<int>{9, 7, 6, 3, 8});
    REQUIRE(cyclic_rotation({1, 2, 3, 4}, 4) == vector<int>{1, 2, 3, 4});
    REQUIRE(cyclic_rotation({0, 0, 0}, 1) == vector<int>{0, 0, 0});
}
