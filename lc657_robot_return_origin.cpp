...
// Also, assume that the magnitude of the robot's movement is the same for
// each move.
//
// Example 1:
// Input: "UD"
...
////////////////////////////////////////////////////////////////////////////////
TEST_CASE("Robot Return to Origin", "[leetcode]")
{
    REQUIRE(judgeCircle("UD"));
    REQUIRE_FALSE(judgeCircle("LL"));
}